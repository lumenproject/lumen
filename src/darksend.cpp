...
{
    if(fLiteMode) return; // ignore all Lumen related functionality
...
/*
    ...
    allow endless transaction that would bloat Lumen and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("lumen-privatesend");
