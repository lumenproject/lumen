    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Lumen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lumen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lumen: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Lumen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lumen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lumen Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lumen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lumen addresses"));
    ...
    openAction->setStatusTip(tr("Open a lumen: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lumen Core help message to get a list with possible Lumen Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lumen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lumen network", "", count));
}
...
{
    QString strTitle = tr("Lumen Core"); // default title
