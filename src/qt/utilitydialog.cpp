    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Lumen Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Lumen Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  lumen-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Lumen in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LEN, 0.1 LEN, 1 LEN and 10 LEN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lumencoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://lumencoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Lumen Core is shutting down...") + "<br /><br />" +
